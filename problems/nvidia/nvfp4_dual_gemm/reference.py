...
def ref_kernel(
    ...
    """
    a_ref, b1_ref, b2_ref, sfa_ref_cpu, sfb1_ref_cpu, sfb2_ref_cpu, c_ref = data
...
def generate_input(
    ...
    sfb1_ref_cpu = create_scale_factor_tensors(l, n, sf_k)
    sfb2_ref_cpu = create_scale_factor_tensors(l, n, sf_k)

    return (a_ref, b1_ref, b2_ref, sfa_ref_cpu, sfb1_ref_cpu, sfb2_ref_cpu, c_ref)
