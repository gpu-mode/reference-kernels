...
def generate_input(
    ...
    return a_tensor, b_tensor, c_tensor, c, ref


def check_implementation(ref, c_tensor):
    torch.testing.assert_close(
        c_tensor.cpu(), ref.to(cutlass_torch.dtype(io_dtype)), atol=1e-01, rtol=1e-05
    )
    print("PASS")

a_tensor, b_tensor, c_tensor, c, ref = generate_input(m=1024, n=1024, k=1024, seed=1111)
ref_kernel(a_tensor, b_tensor, c_tensor)
check_implementation(ref, c)